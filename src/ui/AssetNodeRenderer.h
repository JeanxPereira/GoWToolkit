...
// ── Forward declaration ────────────────────────────────────────────────────
inline void RenderAssetNodeRow(const AssetNode& node);

// ── Render an entire AssetNode tree ────────────────────────────────────────
// Call from InfoTab — replaces the hand-wired switch-case.
inline void RenderAssetNode(const AssetNode& node) {
