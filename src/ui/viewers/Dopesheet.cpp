...
Dopesheet::Dopesheet() {
    EventAnimationLoaded::subscribe(this, [this](std::shared_ptr<GOW::AnimationData> data) {
...
void GatherJointIds(const GOW::AnimSubstream& s, std::set<int>& out) {
...
void GatherFromState(const GOW::SkinningState& st, std::set<int>& outJoints,
...
void CollectRanges(const GOW::AnimSubstream& s, int jointId,
...
void Dopesheet::Draw() {
    ...
    GOW::AnimationPlayer* player = GOW::UI::GetActiveAnimationPlayer();
