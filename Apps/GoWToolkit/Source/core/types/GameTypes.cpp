...
Onyx::Types::TypeId Unknown, EntityCount, GroupStart, GroupEnd, HeaderStart, HeaderPop,
...
void RegisterGameTypes() {
    ...
    for (const auto& row : kGameTypeTable) {
        ...
        Onyx::Types::TypeId id = cat.Register(info, row.legacyValue);  // force value == legacy
